 ...
 */
final class Version20250808225243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ingredient_recette ADD id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recette ADD source_url VARCHAR(500) NOT NULL, ADD image_url VARCHAR(500) DEFAULT NULL, ADD image_path VARCHAR(255) DEFAULT NULL, ADD image_alt VARCHAR(100) DEFAULT NULL, DROP sourceUrl, CHANGE temps_preparation temps_preparation INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ingredient_recette MODIFY id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX `PRIMARY` ON ingredient_recette
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ingredient_recette DROP id
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ingredient_recette ADD PRIMARY KEY (recette_id, ingredient_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recette ADD sourceUrl VARCHAR(50) DEFAULT NULL, DROP source_url, DROP image_url, DROP image_path, DROP image_alt, CHANGE temps_preparation temps_preparation INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
