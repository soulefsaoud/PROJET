 ...
 */
final class Version20250808230323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recette ADD image_url VARCHAR(500) DEFAULT NULL, ADD image_path VARCHAR(255) DEFAULT NULL, ADD image_alt VARCHAR(100) DEFAULT NULL, DROP sourceUrl, CHANGE temps_preparation temps_preparation INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recette ADD sourceUrl VARCHAR(50) DEFAULT NULL, DROP image_url, DROP image_path, DROP image_alt, CHANGE temps_preparation temps_preparation INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
