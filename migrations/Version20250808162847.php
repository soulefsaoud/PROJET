 ...
 */
final class Version20250808162847 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recette DROP descriptions, DROP source_url, DROP image_url, DROP image_path, DROP image_alt, CHANGE temps_preparation temps_preparation INT NOT NULL, CHANGE difficulte difficulte VARCHAR(80) NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE nombre_de_portions nombre_de_portions INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
