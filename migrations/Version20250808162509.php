 ...
 */
final class Version20250808162509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ingredient CHANGE unite_mesure unite_mesure VARCHAR(255) DEFAULT NULL, CHANGE quantite quantite INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ingredient CHANGE quantite quantite VARCHAR(255) DEFAULT NULL, CHANGE unite_mesure unite_mesure VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
