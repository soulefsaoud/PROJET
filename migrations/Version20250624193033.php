 ...
 */
final class Version20250624193033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE menu (
              ...
              INDEX IDX_7D053A93A76ED395 (user_id),
              PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE menu_recette (
              ...
              recette_id INT NOT NULL,
              INDEX IDX_C1607E2ECCD7E912 (menu_id),
              INDEX IDX_C1607E2E89312FE9 (recette_id),
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE recette (
              ...
              difficulte VARCHAR(80) DEFAULT NULL,
              date_creation DATETIME DEFAULT NULL,
              nombre_de_portions INT DEFAULT NULL,
              PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE regime_recette (
              ...
              recette_id INT NOT NULL,
              INDEX IDX_D4095CF735E7D534 (regime_id),
              INDEX IDX_D4095CF789312FE9 (recette_id),
              PRIMARY KEY(regime_id, recette_id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user (
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              menu_recette
            ADD
              CONSTRAINT FK_C1607E2ECCD7E912 FOREIGN KEY (menu_id) REFERENCES menu (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              menu_recette
            ADD
              CONSTRAINT FK_C1607E2E89312FE9 FOREIGN KEY (recette_id) REFERENCES recette (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              regime_recette
            ADD
              CONSTRAINT FK_D4095CF735E7D534 FOREIGN KEY (regime_id) REFERENCES regime (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              regime_recette
            ADD
              CONSTRAINT FK_D4095CF789312FE9 FOREIGN KEY (recette_id) REFERENCES recette (id) ON DELETE CASCADE
        SQL);
    }
